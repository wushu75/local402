...
<!-- Upload your demo clip to assets/demo.gif in this repo, then this renders automatically. -->
...
Want to shape it? [Open an issue.](https://github.com/wushu75/local402/issues)
